...
export class OAuthAuthProvider implements core.AuthProvider {
    ...
    private readonly authClient: OauthClient;
    ...
    constructor(options: OAuthAuthProvider.Options & OAuthAuthProvider.ClientCredentials) {
                ...
                this.authClient = new OauthClient(options);
    ...
    private async clientIdSupplier({ endpointMetadata }: {
    ...
    private async clientSecretSupplier({ endpointMetadata }: {
            endpointMetadata?: core.EndpointMetadata;
        } = {}): Promise<string> {
            ...
            endpointMetadata?: core.EndpointMetadata;
                ...
                this.refreshPromise = (async () => {
                    try {
                        ...
                        this.expiresAt = this.getExpiresAt((tokenResponse.expires_in ?? 3600), BUFFER_IN_MINUTES);
                        return this.accessToken;
                    } finally {
...
export class OAuthTokenOverrideAuthProvider implements core.AuthProvider {
    ...
    public static canCreate(options?: Partial<OAuthAuthProvider.TokenOverride & BaseClientOptions>): options is OAuthAuthProvider.TokenOverride {
...
export namespace OAuthAuthProvider {
    ...
    export type ClientCredentials = {
                [CLIENT_ID_PARAM]: core.Supplier<string>; [CLIENT_SECRET_PARAM]: core.Supplier<string>
            };
