...
import { OAuth2Client } from "../api/resources/oAuth2/client/Client.js";
...
export class OAuthAuthProvider implements core.AuthProvider {
    ...
    private readonly _authClient: OAuth2Client;
    ...
    constructor(options: OAuthAuthProvider.Options & OAuthAuthProvider.AuthOptions.ClientCredentials) {
        ...
        this._authClient = new OAuth2Client(options);
    ...
    private async refresh(_arg?: { endpointMetadata?: core.EndpointMetadata }): Promise<string> {
        this._refreshPromise = (async () => {
            try {
                ...
                this._expiresAt = this.getExpiresAt(tokenResponse.expires_in ?? 3600, this.BUFFER_IN_MINUTES);
                return this._accessToken;
            } finally {
