 ...
 */
export declare class Sensors extends Message<Sensors> {
  /**
 ...
 */
export declare class FieldOfView extends Message<FieldOfView> {
  /**
 ...
 */
export declare class ProjectedFrustum extends Message<ProjectedFrustum> {
  /**
 ...
 */
export declare class RFConfiguration extends Message<RFConfiguration> {
  /**
 ...
 */
export declare class BandwidthRange extends Message<BandwidthRange> {
  /**
 ...
 */
export declare class Bandwidth extends Message<Bandwidth> {
  /**
