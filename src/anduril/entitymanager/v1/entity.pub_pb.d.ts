...
import type { GeoDetails, GeoPolygon, GeoShape } from "./geoentity.pub_pb";
import type { Correlated } from "./correlations.pub_pb";
 ...
 */
export declare type Entities = Message<"anduril.entitymanager.v1.Entities"> & {
  /**
 ...
 * @deprecated
 */
export declare type OverrideProvenance = Message<"anduril.entitymanager.v1.OverrideProvenance"> & {
  /**
   * proto field path which is the string representation of a field.
   * example: correlated.primary_entity_id would be primary_entity_id in correlated component
   *
 ...
 * @deprecated
 */
export declare const OverrideProvenanceSchema: GenMessage<OverrideProvenance>;
 ...
 */
export declare type OriginalData = Message<"anduril.entitymanager.v1.OriginalData"> & {
  /**
 ...
 */
export declare const OriginalDataSchema: GenMessage<OriginalData>;
 ...
 */
export declare type OriginalData_TLE = Message<"anduril.entitymanager.v1.OriginalData.TLE"> & {
  /**
 ...
 */
export declare const OriginalData_TLESchema: GenMessage<OriginalData_TLE>;
 ...
 */
export declare type TeamStatus = Message<"anduril.entitymanager.v1.TeamStatus"> & {
};
 ...
 */
export declare const TeamStatusSchema: GenMessage<TeamStatus>;
 ...
 */
export declare const DeletableSchema: GenEnum<Deletable>;
 ...
 */
export declare const InteractivityModeSchema: GenEnum<InteractivityMode>;
