...
import { DoubleValue, Int32Value, Message, proto3 } from "@bufbuild/protobuf";
import { Position } from "./location.pub_pb.js";
import { Pose, TMat2 } from "../../type/coords.pub_pb.js";
...
// Retrieve enum metadata with: proto3.getEnumType(ModulationType)
proto3.util.setEnumType(ModulationType, "anduril.entitymanager.v1.ModulationType", [
  { no: 0, name: "MODULATION_TYPE_INVALID" },
  { no: 1, name: "MODULATION_TYPE_AMPLITUDE" },
  { no: 2, name: "MODULATION_TYPE_FREQUENCY" },
  { no: 3, name: "MODULATION_TYPE_PHASE" },
  { no: 4, name: "MODULATION_TYPE_SPACED" },
  { no: 5, name: "MODULATION_TYPE_AMPLITUDE_SHIFT_KEYING" },
  { no: 6, name: "MODULATION_TYPE_FREQUENCY_SHIFT_KEYING" },
  { no: 7, name: "MODULATION_TYPE_PHASE_SHIFT_KEYING" },
  { no: 8, name: "MODULATION_TYPE_MINIMUM_SHIFT_KEYING" },
  { no: 9, name: "MODULATION_TYPE_MINIMUM_SHIFT_KEYING_GAUSSIAN" },
  { no: 10, name: "MODULATION_TYPE_SINGLE_SIDE_BAND_UPPER" },
  { no: 11, name: "MODULATION_TYPE_SINGLE_SIDE_BAND_LOWER" },
  { no: 12, name: "MODULATION_TYPE_SINGLE_SIDE_BAND_FULL_CARRIER" },
  { no: 13, name: "MODULATION_TYPE_SINGLE_SIDE_BAND_SUPPRESSED_CARRIER" },
  { no: 14, name: "MODULATION_TYPE_SINGLE_SIDE_BAND_REDUCED_CARRIER" },
  { no: 15, name: "MODULATION_TYPE_SINGLE_SIDE_BAND_WITHOUT_CARRIER" },
  { no: 16, name: "MODULATION_TYPE_DUAL_SIDE_BAND_FULL_CARRIER" },
  { no: 17, name: "MODULATION_TYPE_DUAL_SIDE_BAND_SUPPRESSED_CARRIER" },
  { no: 18, name: "MODULATION_TYPE_DUAL_SIDE_BAND_REDUCED_CARRIER" },
  { no: 19, name: "MODULATION_TYPE_DUAL_SIDE_BAND_WITHOUT_CARRIER" },
  { no: 20, name: "MODULATION_TYPE_INDEPENDENT_SIDE_BAND" },
  { no: 21, name: "MODULATION_TYPE_VESTIGIAL_SIDE_BAND" },
  { no: 22, name: "MODULATION_TYPE_ON_OFF_KEYING" },
  { no: 23, name: "MODULATION_TYPE_MULTI_FREQUENCY_SHIFT_KEYING" },
  { no: 24, name: "MODULATION_TYPE_AUDIO_FREQUENCY_SHIFT_KEYING" },
  { no: 25, name: "MODULATION_TYPE_CONTINUOUS_PHASE_FREQUENCY_SHIFT_KEYING" },
  { no: 26, name: "MODULATION_TYPE_C_PHASE_SHIFT_KEYING" },
  { no: 27, name: "MODULATION_TYPE_DIFFERENTIALLY_ENCODED_BINARY_PHASE_SHIFT_KEYING" },
  { no: 28, name: "MODULATION_TYPE_DIFFERENTIALLY_ENCODED_QUADRATURE_PHASE_SHIFT_KEYING" },
  { no: 29, name: "MODULATION_TYPE_OFFSET_QUADRATURE_PHASE_SHIFT_KEYING" },
  { no: 30, name: "MODULATION_TYPE_DIFFERENTIAL_PHASE_SHIFT_KEYING" },
  { no: 31, name: "MODULATION_TYPE_PI_4_QUADRATURE_PHASE_SHIFT_KEYING" },
  { no: 32, name: "MODULATION_TYPE_STACKED_OVERLAPPING_QUADRATURE_PHASE_SHIFT_KEYING" },
  { no: 33, name: "MODULATION_TYPE_F_QUADRATURE_PHASE_SHIFT_KEYING" },
  { no: 34, name: "MODULATION_TYPE_QUADRATURE_AMPLITUDE_ANALOG" },
  { no: 35, name: "MODULATION_TYPE_QUADRATURE_AMPLITUDE_DIGITAL" },
  { no: 36, name: "MODULATION_TYPE_CONTINUOUS_PHASE" },
  { no: 37, name: "MODULATION_TYPE_PULSE_POSITION" },
  { no: 38, name: "MODULATION_TYPE_TRELLIS_CODE" },
  { no: 39, name: "MODULATION_TYPE_ORTHOGONAL_FREQUENCY_DIVISION_MULTIPLEXING" },
  { no: 40, name: "MODULATION_TYPE_FREQUENCY_HOPPING_SPREAD_SPECTRUM" },
  { no: 41, name: "MODULATION_TYPE_DIGITAL_SEQUENCE_SPREAD_SPECTRUM" },
]);
...
// Retrieve enum metadata with: proto3.getEnumType(ScanType)
proto3.util.setEnumType(ScanType, "anduril.entitymanager.v1.ScanType", [
  { no: 0, name: "SCAN_TYPE_INVALID" },
  { no: 1, name: "SCAN_TYPE_CIRCULAR" },
  { no: 2, name: "SCAN_TYPE_BIDIRECTIONAL_HORIZONTAL_SECTOR" },
  { no: 3, name: "SCAN_TYPE_BIDIRECTIONAL_VERTICAL_SECTOR" },
  { no: 4, name: "SCAN_TYPE_NON_SCANNING" },
  { no: 5, name: "SCAN_TYPE_IRREGULAR" },
  { no: 6, name: "SCAN_TYPE_CONICAL" },
  { no: 7, name: "SCAN_TYPE_LOBE_SWITCHING" },
  { no: 8, name: "SCAN_TYPE_RASTER" },
  { no: 9, name: "SCAN_TYPE_CIRCULAR_VERTICAL_SECTOR" },
  { no: 10, name: "SCAN_TYPE_CIRCULAR_CONICAL" },
  { no: 11, name: "SCAN_TYPE_SECTOR_CONICAL" },
  { no: 12, name: "SCAN_TYPE_AGILE_BEAM" },
  { no: 13, name: "SCAN_TYPE_UNIDIRECTIONAL_VERTICAL_SECTOR" },
  { no: 14, name: "SCAN_TYPE_UNIDIRECTIONAL_HORIZONTAL_SECTOR" },
  { no: 15, name: "SCAN_TYPE_UNIDIRECTIONAL_SECTOR" },
  { no: 16, name: "SCAN_TYPE_BIDIRECTIONAL_SECTOR" },
]);
 ...
 */
export class EmitterNotation extends Message<EmitterNotation> {
  /**
  ...
  static equals(a: EmitterNotation | PlainMessage<EmitterNotation> | undefined, b: EmitterNotation | PlainMessage<EmitterNotation> | undefined): boolean {
    return proto3.util.equals(EmitterNotation, a, b);
  }
}
...
export class Measurement extends Message<Measurement> {
  ...
  static equals(a: Measurement | PlainMessage<Measurement> | undefined, b: Measurement | PlainMessage<Measurement> | undefined): boolean {
    return proto3.util.equals(Measurement, a, b);
  }
}
 ...
 */
export class Frequency extends Message<Frequency> {
  /**
 ...
 */
export class FrequencyRange extends Message<FrequencyRange> {
  /**
  ...
  static equals(a: FrequencyRange | PlainMessage<FrequencyRange> | undefined, b: FrequencyRange | PlainMessage<FrequencyRange> | undefined): boolean {
    return proto3.util.equals(FrequencyRange, a, b);
  }
}
 ...
 */
export class LineOfBearing extends Message<LineOfBearing> {
  /**
  ...
  static equals(a: LineOfBearing | PlainMessage<LineOfBearing> | undefined, b: LineOfBearing | PlainMessage<LineOfBearing> | undefined): boolean {
    return proto3.util.equals(LineOfBearing, a, b);
  }
}
 ...
 */
export class AngleOfArrival extends Message<AngleOfArrival> {
  /**
  ...
  static equals(a: AngleOfArrival | PlainMessage<AngleOfArrival> | undefined, b: AngleOfArrival | PlainMessage<AngleOfArrival> | undefined): boolean {
    return proto3.util.equals(AngleOfArrival, a, b);
  }
}
 ...
 */
export class Fixed extends Message<Fixed> {
 ...
 */
export class RangeBearing extends Message<RangeBearing> {
  /**
  ...
  static equals(a: RangeBearing | PlainMessage<RangeBearing> | undefined, b: RangeBearing | PlainMessage<RangeBearing> | undefined): boolean {
    return proto3.util.equals(RangeBearing, a, b);
  }
}
 ...
 */
export class PulseRepetitionInterval extends Message<PulseRepetitionInterval> {
  /**
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): PulseRepetitionInterval {
    return new PulseRepetitionInterval().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): PulseRepetitionInterval {
    return new PulseRepetitionInterval().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): PulseRepetitionInterval {
    return new PulseRepetitionInterval().fromJsonString(jsonString, options);
  }
  ...
  static equals(a: PulseRepetitionInterval | PlainMessage<PulseRepetitionInterval> | undefined, b: PulseRepetitionInterval | PlainMessage<PulseRepetitionInterval> | undefined): boolean {
    return proto3.util.equals(PulseRepetitionInterval, a, b);
  }
}
 ...
 */
export class ScanCharacteristics extends Message<ScanCharacteristics> {
  /**
   * @generated from field: anduril.entitymanager.v1.ScanType scan_type = 1;
   */
  scanType = ScanType.INVALID;
  ...
  static equals(a: ScanCharacteristics | PlainMessage<ScanCharacteristics> | undefined, b: ScanCharacteristics | PlainMessage<ScanCharacteristics> | undefined): boolean {
    return proto3.util.equals(ScanCharacteristics, a, b);
  }
}
