...
// Retrieve enum metadata with: proto3.getEnumType(AltIdType)
proto3.util.setEnumType(AltIdType, "anduril.entitymanager.v1.AltIdType", [
  { no: 0, name: "ALT_ID_TYPE_INVALID" },
  { no: 1, name: "ALT_ID_TYPE_TRACK_ID_2" },
  { no: 12, name: "ALT_ID_TYPE_TRACK_ID_1" },
  { no: 2, name: "ALT_ID_TYPE_SPI_ID" },
  { no: 3, name: "ALT_ID_TYPE_NITF_FILE_TITLE" },
  { no: 4, name: "ALT_ID_TYPE_TRACK_REPO_ALERT_ID" },
  { no: 5, name: "ALT_ID_TYPE_ASSET_ID" },
  { no: 6, name: "ALT_ID_TYPE_LINK16_TRACK_NUMBER" },
  { no: 7, name: "ALT_ID_TYPE_LINK16_JU" },
  { no: 8, name: "ALT_ID_TYPE_NCCT_MESSAGE_ID" },
  { no: 9, name: "ALT_ID_TYPE_CALLSIGN" },
  { no: 10, name: "ALT_ID_TYPE_MMSI_ID" },
  { no: 11, name: "ALT_ID_TYPE_VMF_URN" },
  { no: 13, name: "ALT_ID_TYPE_IMO_ID" },
  { no: 14, name: "ALT_ID_TYPE_VMF_TARGET_NUMBER" },
  { no: 15, name: "ALT_ID_TYPE_SERIAL_NUMBER" },
  { no: 16, name: "ALT_ID_TYPE_REGISTRATION_ID" },
  { no: 17, name: "ALT_ID_TYPE_IBS_GID" },
  { no: 18, name: "ALT_ID_TYPE_DODAAC" },
  { no: 19, name: "ALT_ID_TYPE_UIC" },
  { no: 20, name: "ALT_ID_TYPE_NORAD_CAT_ID" },
]);
...
// Retrieve enum metadata with: proto3.getEnumType(Template)
proto3.util.setEnumType(Template, "anduril.entitymanager.v1.Template", [
  { no: 0, name: "TEMPLATE_INVALID" },
  { no: 1, name: "TEMPLATE_TRACK" },
  { no: 2, name: "TEMPLATE_SENSOR_POINT_OF_INTEREST" },
  { no: 3, name: "TEMPLATE_ASSET" },
  { no: 4, name: "TEMPLATE_GEO" },
  { no: 5, name: "TEMPLATE_SIGNAL_OF_INTEREST" },
]);
...
proto3.util.setEnumType(Source, "anduril.entitymanager.v1.Source", [
  { no: 0, name: "SOURCE_INVALID" },
  { no: 1, name: "SOURCE_ANDURIL" },
  { no: 2, name: "SOURCE_LINK_16" },
  { no: 3, name: "SOURCE_VMF" },
  { no: 4, name: "SOURCE_ADSB" },
  { no: 5, name: "SOURCE_CURSOR_ON_TARGET" },
  { no: 6, name: "SOURCE_MAXAR" },
  { no: 7, name: "SOURCE_MARTAC" },
  { no: 8, name: "SOURCE_SAILDRONE" },
  { no: 9, name: "SOURCE_HE_360" },
  { no: 10, name: "SOURCE_OFX" },
  { no: 11, name: "SOURCE_BAS_T" },
  { no: 12, name: "SOURCE_KINETICA" },
  { no: 13, name: "SOURCE_USER" },
  { no: 14, name: "SOURCE_NCCT" },
  { no: 15, name: "SOURCE_AIS" },
  { no: 16, name: "SOURCE_KLV" },
  { no: 17, name: "SOURCE_NITF" },
  { no: 18, name: "SOURCE_TAK" },
  { no: 19, name: "SOURCE_SPIRE_AIS" },
  { no: 20, name: "SOURCE_SEFI" },
  { no: 21, name: "SOURCE_ADSB_EXCHANGE" },
  { no: 22, name: "SOURCE_LIVE_UA_MAP" },
  { no: 23, name: "SOURCE_CRUCIBLE" },
  { no: 24, name: "SOURCE_IBS" },
  { no: 25, name: "SOURCE_ADVANA" },
  { no: 26, name: "SOURCE_THRESHER" },
  { no: 27, name: "SOURCE_SEATRACKS" },
  { no: 28, name: "SOURCE_TASS" },
  { no: 30, name: "SOURCE_SMART_SENSOR" },
  { no: 31, name: "SOURCE_STRIVEWORKS" },
  { no: 32, name: "SOURCE_L3H_THEIA" },
  { no: 33, name: "SOURCE_TALON_POWDERHORN" },
  { no: 34, name: "SOURCE_IDT_VIRTUAL_TWIN" },
  { no: 35, name: "SOURCE_MISSION_AUTONOMY" },
  { no: 36, name: "SOURCE_GCCS" },
  { no: 37, name: "SOURCE_FOUNDRY" },
  { no: 38, name: "SOURCE_MIDB" },
  { no: 39, name: "SOURCE_FOM" },
  { no: 40, name: "SOURCE_GALE" },
]);
...
// Retrieve enum metadata with: proto3.getEnumType(OverrideStatus)
proto3.util.setEnumType(OverrideStatus, "anduril.entitymanager.v1.OverrideStatus", [
  { no: 0, name: "OVERRIDE_STATUS_INVALID" },
  { no: 1, name: "OVERRIDE_STATUS_APPLIED" },
  { no: 2, name: "OVERRIDE_STATUS_PENDING" },
  { no: 3, name: "OVERRIDE_STATUS_TIMEOUT" },
  { no: 4, name: "OVERRIDE_STATUS_REJECTED" },
  { no: 5, name: "OVERRIDE_STATUS_DELETION_PENDING" },
]);
...
// Retrieve enum metadata with: proto3.getEnumType(OverrideType)
proto3.util.setEnumType(OverrideType, "anduril.entitymanager.v1.OverrideType", [
  { no: 0, name: "OVERRIDE_TYPE_INVALID" },
  { no: 1, name: "OVERRIDE_TYPE_LIVE" },
  { no: 2, name: "OVERRIDE_TYPE_POST_EXPIRY" },
]);
