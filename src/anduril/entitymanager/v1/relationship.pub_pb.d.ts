 ...
 */
export declare type Tether = Message<"anduril.entitymanager.v1.Tether"> & {
};
 ...
 */
export declare const TetherSchema: GenMessage<Tether>;
 ...
 */
export declare type Configure = Message<"anduril.entitymanager.v1.Configure"> & {
};
 ...
 */
export declare const ConfigureSchema: GenMessage<Configure>;
