 ...
 */
export declare enum EciReferenceFrame {
  /**
 ...
 */
export declare class OrbitMeanElements extends Message<OrbitMeanElements> {
  /**
  ...
  constructor(data?: PartialMessage<OrbitMeanElements>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "anduril.type.OrbitMeanElements";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): OrbitMeanElements;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): OrbitMeanElements;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): OrbitMeanElements;

  static equals(a: OrbitMeanElements | PlainMessage<OrbitMeanElements> | undefined, b: OrbitMeanElements | PlainMessage<OrbitMeanElements> | undefined): boolean;
}

/**
 * @generated from message anduril.type.OrbitMeanElementsMetadata
 */
export declare class OrbitMeanElementsMetadata extends Message<OrbitMeanElementsMetadata> {
  /**
  ...
  constructor(data?: PartialMessage<OrbitMeanElementsMetadata>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "anduril.type.OrbitMeanElementsMetadata";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): OrbitMeanElementsMetadata;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): OrbitMeanElementsMetadata;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): OrbitMeanElementsMetadata;

  static equals(a: OrbitMeanElementsMetadata | PlainMessage<OrbitMeanElementsMetadata> | undefined, b: OrbitMeanElementsMetadata | PlainMessage<OrbitMeanElementsMetadata> | undefined): boolean;
}

/**
 * @generated from message anduril.type.MeanKeplerianElements
 */
export declare class MeanKeplerianElements extends Message<MeanKeplerianElements> {
  /**
  ...
  constructor(data?: PartialMessage<MeanKeplerianElements>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "anduril.type.MeanKeplerianElements";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): MeanKeplerianElements;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): MeanKeplerianElements;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): MeanKeplerianElements;

  static equals(a: MeanKeplerianElements | PlainMessage<MeanKeplerianElements> | undefined, b: MeanKeplerianElements | PlainMessage<MeanKeplerianElements> | undefined): boolean;
}

/**
 * @generated from message anduril.type.TleParameters
 */
export declare class TleParameters extends Message<TleParameters> {
  /**
  ...
  constructor(data?: PartialMessage<TleParameters>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "anduril.type.TleParameters";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): TleParameters;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): TleParameters;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): TleParameters;

  static equals(a: TleParameters | PlainMessage<TleParameters> | undefined, b: TleParameters | PlainMessage<TleParameters> | undefined): boolean;
}
