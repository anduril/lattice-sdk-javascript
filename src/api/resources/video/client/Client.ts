...
export class VideoClient {
     ...
     *
     * @param {Lattice.ListEgressStreamsRequest} request
    ...
    ): core.HttpResponsePromise<Lattice.ListEgressStreamsResponse> {
    ...
    private async __listEgressStreams(
        request: Lattice.ListEgressStreamsRequest = {},
        requestOptions?: VideoClient.RequestOptions,
    ): Promise<core.WithRawResponse<Lattice.ListEgressStreamsResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as Lattice.ListEgressStreamsResponse, rawResponse: _response.rawResponse };
        }
            ...
            switch (_response.error.statusCode) {
                case 400:
                    throw new Lattice.video.BadRequestError(
                        _response.error.body as Lattice.GoogleRpcStatus,
     ...
     *
     * @param {Lattice.CreateEgressStreamRequest} request
     * @param {VideoClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Lattice.video.BadRequestError}
     * @throws {@link Lattice.video.UnauthorizedError}
    ...
    public createEgressStream(
        ...
        requestOptions?: VideoClient.RequestOptions,
    ): core.HttpResponsePromise<Lattice.CreateEgressStreamResponse> {
    ...
    private async __createEgressStream(
        request: Lattice.CreateEgressStreamRequest = {},
        requestOptions?: VideoClient.RequestOptions,
    ): Promise<core.WithRawResponse<Lattice.CreateEgressStreamResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        if (_response.ok) {
            return { data: _response.body as Lattice.CreateEgressStreamResponse, rawResponse: _response.rawResponse };
        }
     ...
     *
     * @param {Lattice.GetEgressStreamRequest} request
     * @param {VideoClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Lattice.video.BadRequestError}
     * @throws {@link Lattice.video.UnauthorizedError}
    ...
    public getEgressStream(
        ...
        requestOptions?: VideoClient.RequestOptions,
    ): core.HttpResponsePromise<Lattice.GetEgressStreamResponse> {
    ...
    private async __getEgressStream(
        request: Lattice.GetEgressStreamRequest,
        requestOptions?: VideoClient.RequestOptions,
    ): Promise<core.WithRawResponse<Lattice.GetEgressStreamResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as Lattice.GetEgressStreamResponse, rawResponse: _response.rawResponse };
        }
     ...
     *
     * @param {Lattice.DeleteEgressStreamRequest} request
     * @param {VideoClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Lattice.video.BadRequestError}
     * @throws {@link Lattice.video.UnauthorizedError}
    ...
    public deleteEgressStream(
        ...
        requestOptions?: VideoClient.RequestOptions,
    ): core.HttpResponsePromise<Lattice.DeleteEgressStreamResponse> {
    ...
    private async __deleteEgressStream(
        request: Lattice.DeleteEgressStreamRequest,
        requestOptions?: VideoClient.RequestOptions,
    ): Promise<core.WithRawResponse<Lattice.DeleteEgressStreamResponse>> {
        const { egressId } = request;
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
        ...
        if (_response.ok) {
            return { data: _response.body as Lattice.DeleteEgressStreamResponse, rawResponse: _response.rawResponse };
        }
     ...
     *
     * @param {Lattice.ListIngressStreamsRequest} request
     * @param {VideoClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Lattice.video.BadRequestError}
     * @throws {@link Lattice.video.UnauthorizedError}
    ...
    public listIngressStreams(
        ...
        requestOptions?: VideoClient.RequestOptions,
    ): core.HttpResponsePromise<Lattice.ListIngressStreamsResponse> {
    ...
    private async __listIngressStreams(
        request: Lattice.ListIngressStreamsRequest = {},
        requestOptions?: VideoClient.RequestOptions,
    ): Promise<core.WithRawResponse<Lattice.ListIngressStreamsResponse>> {
        const { pageSize, pageToken } = request;
        const _queryParams: Record<string, unknown> = {
            pageSize,
            pageToken,
        ...
        if (_response.ok) {
            return { data: _response.body as Lattice.ListIngressStreamsResponse, rawResponse: _response.rawResponse };
        }
     ...
     *
     * @param {Lattice.CreateIngressStreamRequest} request
     * @param {VideoClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Lattice.video.BadRequestError}
     * @throws {@link Lattice.video.UnauthorizedError}
    ...
    public createIngressStream(
        ...
        requestOptions?: VideoClient.RequestOptions,
    ): core.HttpResponsePromise<Lattice.CreateIngressStreamResponse> {
    ...
    private async __createIngressStream(
        request: Lattice.CreateIngressStreamRequest = {},
        requestOptions?: VideoClient.RequestOptions,
    ): Promise<core.WithRawResponse<Lattice.CreateIngressStreamResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        if (_response.ok) {
            return { data: _response.body as Lattice.CreateIngressStreamResponse, rawResponse: _response.rawResponse };
        }
     ...
     *
     * @param {Lattice.GetIngressStreamRequest} request
     * @param {VideoClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Lattice.video.BadRequestError}
     * @throws {@link Lattice.video.UnauthorizedError}
    ...
    public getIngressStream(
        ...
        requestOptions?: VideoClient.RequestOptions,
    ): core.HttpResponsePromise<Lattice.GetIngressStreamResponse> {
    ...
    private async __getIngressStream(
        request: Lattice.GetIngressStreamRequest,
        requestOptions?: VideoClient.RequestOptions,
    ): Promise<core.WithRawResponse<Lattice.GetIngressStreamResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as Lattice.GetIngressStreamResponse, rawResponse: _response.rawResponse };
        }
     ...
     *
     * @param {Lattice.DeleteIngressStreamRequest} request
     * @param {VideoClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Lattice.video.BadRequestError}
     * @throws {@link Lattice.video.UnauthorizedError}
    ...
    public deleteIngressStream(
        ...
        requestOptions?: VideoClient.RequestOptions,
    ): core.HttpResponsePromise<Lattice.DeleteIngressStreamResponse> {
    ...
    private async __deleteIngressStream(
        request: Lattice.DeleteIngressStreamRequest,
        requestOptions?: VideoClient.RequestOptions,
    ): Promise<core.WithRawResponse<Lattice.DeleteIngressStreamResponse>> {
        const { ingressId } = request;
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
        ...
        if (_response.ok) {
            return { data: _response.body as Lattice.DeleteIngressStreamResponse, rawResponse: _response.rawResponse };
        }
